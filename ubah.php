...
<body background="images/one.jpg">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Pekerja</a>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                         <li class="nav-item">
                              <a class="nav-link" aria-current="page" href="kk.html">Home</a>
                         </li>
                         <li class="nav-item">
                              <a class="nav-link" href="index.php">Data Pekerja</a>
                         </li>
                         <li class="nav-item">
     ...
     gsap.to('.ubah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-pencil-square"></i>Ubah Data Pekerja'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
